        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              <a
                href="#contacto"
                className="inline-flex items-center gap-2 rounded-xl bg-orange px-6 py-3 text-base font-semibold text-white shadow-glow hover:scale-[1.02] hover:shadow-[0_0_50px_rgba(247,127,0,0.3)] transition-all duration-200"
              >
                Experimentar Grátis
                <ArrowRight size={18} />
              </a>
          ...
          >
            {/* Glow behind */}
            <div className="absolute -inset-8 bg-orange/10 blur-3xl rounded-full pointer-events-none" />
            {/* Browser chrome */}
                  ...
                  <div className="flex-1 p-3 sm:p-4 space-y-3 overflow-hidden">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {[
                        ...
                        <div key={kpi.label} className="rounded-lg bg-navy-medium/30 border border-white/5 p-2">
                    ...
                    <div className="rounded-lg bg-navy-medium/20 border border-white/5 p-2">
                      ...
                      {[
                        ...
                        <div key={row.car} className="flex items-center justify-between py-1 border-t border-white/5 text-[8px]">
